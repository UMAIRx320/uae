...
for xd in range(10000):
	a='mozilla/5.0 (linux; android 8.1.0; nokia 6.1 plus)'
	b=random.randrange(1, 9)
	c=random.randrange(1, 9)
	d=' applewebkit/537.36 (khtml, like gecko)'
	e=random.randrange(100, 9999)
	f=' chrome/78.0.3904.62'
	...
	g=' AppleWebKit/537.36 (KHTML, like Gecko) Chrome/88.0.4324.141'
...
def uaku():
	try:
		...
		a=requests.get('https://github.com/UMAIRx320/uae/blob/main/ua2.txt').text
		ua=open('.ua2.txt','w')
...
def grup():
	...
	ua = 'Dalvik/2.1.0 (Linux; U; Android 5.0; SM-G900F Build/LRX21T) [FBAN/FB4A;FBAV/43.0.0.29.147;FBPN/com.facebook.katana;FBLC/en_GB;FBBV/14274161;FBCR/Tele2 LT;FBMF/samsung;FBBD/samsung;FBDV/SM-G900F;FBSV/5.0;FBCA/armeabi-v7a:armeabi;FBDM/{density=3.0,width=1080,height=1920};FB_FW/1;]'
...
def crackfree(idf,pwv):
	...
	sys.stdout.flush()
	ua = random.choice(['Dalvik/2.1.0 (Linux; U; Android 6.0.1; SM-J700F Build/MMB29K) [FBAN/Orca-Android;FBAV/181.0.0.12.78;FBPN/com.facebook.orca;FBLC/tr_TR;FBBV/122216364;FBCR/Turk Telekom;FBMF/samsung;FBBD/samsung;FBDV/SM-J700F;FBSV/6.0.1;FBCA/armeabi-v7a:armeabi;FBDM/{densit'])
	ua2 = random.choice(ugen2)
	ses = requests.Session()
	for pw in pwv:
		try:
...
def ceker(idf,pw):
	global cp
	ua = 'Mozilla/5.0 (Linux; Android 9; SH-01K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/75.0.3770.101 Mobile Safari/537.36'
